...
class Schema {
	...
	public function register_post_types() {
		...
		// Both Profiles and Citations can be featured.
		$featured_types = [ 'ramp_profile', 'ramp_citation' ];
		foreach ( $featured_types as $featured_type ) {
			register_meta(
				'post',
				'is_featured',
				[
					'object_subtype' => $featured_type,
					'type'           => 'boolean',
					'single'         => true,
					'show_in_rest'   => true,
					'description'    => __( 'Item is Featured', 'research-amp' ),
				]
			);
		}
