...
namespace SSRC\RAMP\Libraries;

/**
 * Borrowed under the GPL from https://github.com/gsarig/slashadmin/blob/master/classes/TaxonomyOrder.class.php
 *
 * See https://www.gsarigiannidis.gr/wordpress-post-tags-order/
 *
 * With modifications to make independent of SlashAdmin toolkit.
 */
class TaxonomyOrder {
