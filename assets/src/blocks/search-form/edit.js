...
export default function edit( { attributes, setAttributes } ) {
	const { buttonText, label, placeholder, typeSelectorLabel } = attributes;
			...
			<div className="search-form-top">
				...
				<input
					...
					placeholder={
						placeholder
							? undefined
							: __( 'Optional placeholder…', 'research-amp' )
					}
					value={ placeholder }
					onChange={ ( event ) =>
			...
			<div className="search-form-bottom">
				<div className="search-type-container-label">
					<RichText
						...
						onChange={ ( typeSelectorLabel ) =>
							setAttributes( { typeSelectorLabel } )
						}
						multiline={ false }
					/>
				</div>
				...
				<div className="search-type-select-container">
					<FakeSelect
						text={ __( 'All content types', 'research-amp' ) }
					/>
				</div>
