...
export default function edit( {
	...
	const { headingText, showPublicationDate } = attributes;
	...
	const fakeTOC = (
		<div
			id="ez-toc-container"
			className="ez-toc-v2_0_17 counter-hierarchy ez-toc-grey"
		>
			<nav>
				<ul className="ez-toc-list ez-toc-list-level-1">
					<li className="ez-toc-page-1 ez-toc-heading-level-2">
						<span className="ez-toc-link ez-toc-heading-1">
							Introduction
						</span>
					</li>
					...
					<li className="ez-toc-page-1 ez-toc-heading-level-2">
						...
						<ul className="ez-toc-list-level-3">
							<li className="ez-toc-heading-level-3">
								<span className="ez-toc-link ez-toc-heading-6">
									United States
								</span>
							</li>
